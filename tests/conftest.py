...
CIRCUIT_REGISTRY = [
    ...
    ("2JJ_series",         lambda: [(0, 1, _J()), (0, 1, _C()), (1, 2, _J()), (1, 2, _C()),
                                    (0, 2, _C())]),
    ...
    ("2QPS_series",        lambda: [(0, 1, _P()), (0, 1, _L()), (1, 2, _P()), (1, 2, _L()),
                                    (0, 2, _L())]),
    ...
    ("JJ_QPS_JJ_chain",    lambda: [(0, 1, _J()), (0, 1, _C()), (1, 2, _P()), (1, 2, _L()),
                                    (2, 3, _J()), (2, 3, _C())]),
    ("JJ_JJ_QPS_ring",     lambda: [(0, 1, _J()), (0, 1, _C()), (1, 2, _J()), (1, 2, _C()),
                                    (2, 0, _P()), (2, 0, _L())]),
    ("QPS_QPS_JJ_ring",    lambda: [(0, 1, _P()), (0, 1, _L()), (1, 2, _P()), (1, 2, _L()),
                                    (2, 0, _J()), (2, 0, _C())]),
    # Dualmon Fig. 1 — bare elements without companions
    ("dualmon_bare",       lambda: [(0, 1, _J()), (0, 1, _P())]),
    # dualmon_full: JJ + C on node (1,0), L series (1,2), QPS + parallel L on (2,0),
    # gate Cx on (1,0)
