...
class Geometry:
    def __init__(self, topology, debug: bool = False):
        ...
        self.no_independent_variables, self.no_final_compact_flux = self.omega_function()
    ...
    def omega_function(self):
        ...
        for i, elem in enumerate(self.topo.elements):
            ...
            if isinstance(elem[2], Capacitor):
                omega_2B[i, i + self.topo.no_elements] = -0.5
                omega_2B[i + self.topo.no_elements, i] = 0.5
        ...
        omega_symplectic, V, no_final_compact_flux = omega_symplectic_transformation(
